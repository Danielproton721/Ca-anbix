      ...
      <section id="servicos" className="py-24 bg-surface-container-low">
        <div className="max-w-screen-2xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-primary p-8 rounded-[2rem] shadow-2xl scale-105 relative z-10 border-4 border-secondary-container animate-[pulse-subtle_3s_ease-in-out_infinite]">
      ...
      <section id="contato" className="py-24 bg-surface-container-high relative overflow-hidden">
        <div className="max-w-screen-2xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <a href="https://wa.me/5567981590991?text=Olá! Gostaria de verificar a disponibilidade para locação de caçamba." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-[#25D366] text-white font-black px-8 py-4 rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-3 text-lg">
